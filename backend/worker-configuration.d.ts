/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 500fffdfb56586788140c6f9dc8af547)
// Runtime types generated with workerd@1.20260521.1 2026-04-14 nodejs_compat
interface __BaseEnv_Env {
	SOURCE_FILES_BUCKET: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	WORKSPACE_PRODUCT_ANALYTICS: AnalyticsEngineDataset;
	EXTRACTION_JOBS_QUEUE: Queue;
	AI: Ai;
	ASSETS: Fetcher;
	AI_GATEWAY_ID: "default";
	AI_GATEWAY_REQUEST_TIMEOUT_MS: "300000";
	AI_MODEL: "google/gemini-3-flash";
	BETTER_AUTH_TRUSTED_ORIGINS: "https://extract.t3m.uk,http://localhost:5173,http://127.0.0.1:5173,http://localhost:8787";
	MAX_SOURCE_FILE_BYTES: "10485760";
	...
	WORKSPACE_PRODUCT_STORE: DurableObjectNamespace<import("./src/index").WorkspaceProductStore>;
	WORKSPACE_BILLING_LEDGER: DurableObjectNamespace<import("./src/index").WorkspaceBillingLedger>;
	DOCUMENT_PROCESSING_WORKFLOW: Workflow<Parameters<import("./src/index").DocumentProcessingWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WorkspaceProductStore" | "WorkspaceBillingLedger";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "AI_GATEWAY_REQUEST_TIMEOUT_MS" | "AI_MODEL" | "BETTER_AUTH_TRUSTED_ORIGINS" | "MAX_SOURCE_FILE_BYTES" | "STRIPE_MAX_MONTHLY_PRICE_ID" | "STRIPE_PRO_MONTHLY_PRICE_ID" | "AI_GATEWAY_TOKEN" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "STRIPE_API_KEY" | "STRIPE_WEBHOOK_SECRET">> {}
}
