            ...
            async run() {
              if (sql.includes("INSERT INTO jobs")) {
                ...
                jobs.push({
                  ...
                  status: "queued",
                  image_r2_key: String(sourceFileKey),
                  image_mime_type: String(sourceMimeType),
                  image_name: sourceName === null ? null : String(sourceName),
    ...
    jobs.push(
      {
        ...
        template_version: 3,
        status: "completed",
        image_r2_key: "workspaces/workspace_test/jobs/completed_job/source.pdf",
        image_mime_type: "application/pdf",
        image_name: "completed.pdf",
        created_at: "2026-05-06T12:00:00.000Z",
      ...
      },
      {
        ...
        template_version: 3,
        status: "failed",
        image_r2_key: "workspaces/workspace_test/jobs/failed_job/source.pdf",
        image_mime_type: "application/pdf",
        image_name: "failed.pdf",
        created_at: "2026-05-06T12:00:00.000Z",
        updated_at: "2026-05-06T12:02:00.000Z",
        current_attempt: 1,
