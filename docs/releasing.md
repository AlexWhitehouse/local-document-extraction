...
The entire `.scratch/` directory is untracked and ignored, including local PRDs, issues, research, and generated CI output. Earlier commits and release tags retain their original contents; this cleanup does not rewrite history.
