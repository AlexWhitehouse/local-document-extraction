...
Both workflows passed checksum-verified Actionlint 1.7.12 and structural YAML checks locally. Four-target Actions results are still pending; workflow configuration is not evidence that a remote runner has passed. No release tag or public assets were published by these changes.
