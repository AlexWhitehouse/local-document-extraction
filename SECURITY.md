...
Private reporting must be enabled before the first public release; the [release checklist](docs/releasing.md) tracks this gate. There is no published security support lifetime or promised response time yet. Use the latest qualified release and review its notes before upgrades.
